  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Reviews', [
      ...
      */
      ...
      {
        businessId: '4', userId: '17', typeId: '2',
        upVoteCount: '9', downVoteCount: '1', businessRating: 5,
        reviewText: 'I got takeout for my birthday during the Covid-19 shelter in place. The line was long, but soooo worth it. I got Sesame beef, garlic noodles, green beans, tea leaf salad, and spicy pork. Every single dish was so special and perfect. :)',
        videoLink: '',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        businessId: '4', userId: '18', typeId: '2',
        upVoteCount: '3', downVoteCount: '0', businessRating: 5,
        reviewText: 'Chili lamb from Burma superstar was a superstar dish! I loved the spice so if you like spicy food, this will definitely bring you back for more. Food came pretty fast and it was hot! The onions were crunchy and delicious!\n\nPros: good spice, good crunch for veggies, thin meat\nCons: a bit expensive',
        videoLink: '',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        businessId: '5', userId: '19', typeId: '2',
        upVoteCount: '5', downVoteCount: '0', businessRating: 5,
        reviewText: 'The chicken wings here are delicious. They are fried to a perfect crisp, and covered in a sweet and slightly spicy sauce. I also like ordering the pork fried rice.\n\nThe restaurant becomes full within 30 minutes of opening, so I would get there early.The waiting line goes all the way outside the store, but you can also eat next door at San Tung #2. They have a smaller menu and their own kitchen, but the taste is still the same.To avoid the wait, consider ordering for pick up.The service is good and they do their best as they are constantly busy.\n\nI highly recommend this place for their wings.Don\'t forget to order extra to take home ;)',
        videoLink: '',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        businessId: '5', userId: '11', typeId: '2',
        upVoteCount: '4', downVoteCount: '0', businessRating: 4,
        reviewText: 'The best dry fried chicken wings ever. I won\'t go to SF and not pick up an order or 3 huh so yummy.Next time I\'m gonna try the dry fried green beans. Great sport. I\'m so craving them.I wanted to go for a drive but...COVID - 19 LOOKS LIKE YOUR TEMP CLOSED. Please open soon. Miss you guys',
        videoLink: '',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        businessId: '6', userId: '12', typeId: '2',
        upVoteCount: '1', downVoteCount: '0', businessRating: 5,
      ...
      {
        businessId: '7', userId: '15', typeId: '2',
        upVoteCount: '3', downVoteCount: '1', businessRating: 5,
      ...
      {
        businessId: '10', userId: '11', typeId: '2',
        upVoteCount: '13', downVoteCount: '2', businessRating: 4,
      ...
      {
        businessId: '10', userId: '12', typeId: '2',
        upVoteCount: '11', downVoteCount: '1', businessRating: 5,
